...
describe Envoy::Broker do
  ...
  before do
    ...
    @queue_1 = MockQueue.new 'queue_1', 'message_1' => 'Worker1', 'message_2' => 'Worker2'
    @queue_2 = MockQueue.new 'queue_2', 'message_1' => Worker3
    @queue_3 = MockQueue.new 'queue_3', 'message_1' => Worker3, 'message_2' => 'Worker3'
  end
